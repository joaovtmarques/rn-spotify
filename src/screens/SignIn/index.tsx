    ...
    <SafeAreaView className="flex-1 bg-primary ">
      <View className="flex-1 p-7">
        ...
        <View className="items-center">
          <Text className="text-primaryGrey text-center text-[30px] font-sBold mt-20 mb-5">
            Sign In
          </Text>
          ...
          <View className="w-full">
            <Button
              ...
              styles={{
                sButton:
                  'h-[80px] w-full bg-primaryGreen rounded-[30px] items-center justify-center mt-9',
          ...
          <View className="w-full flex-row justify-center mt-14">
            ...
            <TouchableOpacity>
              <Text className="text-sm text-blue font-sBold">Register Now</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
